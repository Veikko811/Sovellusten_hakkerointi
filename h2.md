...
Tehtävän tavoite on löytää admin salasana. Kokeilin aluksi vain syöttää satunnaisia numeroita syötekenttään, mutta noin kahden minuutin jälkeen lopetin arvailun ja sirryin kokeilemaan SQL-injektiota.
...
Kokeilemalla hakemistoja  http://127.0.0.2:8000/.git ja  http://127.0.0.2:8000/wp-admin antoivat liput:
...
Tehtävien tekemiseen kului paljon aikaa, mutta lippujen löytäminen oli silti palkitsevaa. Ffuf ohjelmisto oli erittäin kätevä käänteismallinnuksessa, koska se poisti tarpeen syöttää arvoja kenttiin manuaalisesti.
