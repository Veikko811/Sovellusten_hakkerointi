...
Rajapinta muodostuu kotiverkon ja internetissä olevien palveluiden välille. Reititin ja palomuuri toimivat kotiverkon ja internetin välisenä rajapintana. Muodostan yhteyksiä esimerkiksi GitHubiin, Moodleen ja OneDrive palveluihin. Kotiverkkoni on riippuvainen Telian tarjoamasta internet-yhteydestä sekä opiskelussa käytettävistä ulkopuolisista palveluista. 
