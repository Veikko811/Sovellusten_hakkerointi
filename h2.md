...
Tehtävän tavoite on löytää admin salasana. Kokeilin aluksi vain syöttää satunnaisia numeroita syötekenttään, mutta noin minuutin jälkeen lopetin arvailun. Olen käyttänyt javascript ja sql ohjelmointikieliä aikaisemmilla kursseilla, joten avasin Web developer tools valikon Firefox selaimesta. Työkalun kautta voi tarkastella html sivuston syötettyjä objekteja ja syötekentän arvoja. Selain suorittaa ohjelmaansa omalla koneellani, joten voin myös muuttaa muuttujien arvoja ja tyyppejä lähdekoodista käsin. 
