...
Hakutuloksia oli noin 90 kappaletta, joten kokeilin filtteröidä samankokoisia hakemistoja. Lisäsin edellämainitun komennon perään -fs 154, joka poistaa hakemistot joiden koko on 154 tavua. Tuloksena tuli seuraava:

![kuva](FUZZ154.png)

Kokeilemalla hakemistoja .git ja wp-admin sivuston perään antoi liput:
