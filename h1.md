...
Hallinta-alueen ulkopuolella ovat internet-palvelun tarjoaja (Telia) ja kotiosoitteessani oleva televisio. Telian infrastruktuuri on hallinta-alueen ulkopuolella, koska en omista tai hallitse sitä enkä pysty määrittämään sen tietoturva-asetuksia. Televisio on hallinta-alueen ulkopuolella, koska se ei säilytä henkilökohtaisia tietojani eikä ole olennainen osa kurssin harjoitteluympäristöä. Perheen jäsenten käyttämät laitteet, kuten puhelimet ovat myös alueen ulkopuolella, koska en omista tai pysty hallitsemaan niiden tietoturva-asetuksia.

## A3) Rajapinnat ja riippuvuudet
Rajapinta muodostuu kotiverkon ja internetissä olevien palveluiden välille. Reititin ja palomuuri toimivat kotiverkon ja internetin välisenä rajapintana. Kotiverkkoni on riippuvainen Telian tarjoamasta internet-yhteydestä. Kotiverkon ja ulkopuolisten palveluiden välillä siirretään opiskeluun liittyviä tietoja internet-yhteyden kautta. Palveluihin kuuluvat GitHub, Moodle ja OneDrive. Nämä muodostavat riippuvuuksia myös palveluntarjoajiin. Tarvitsen myös etäyhteyden Linux-palvelimelle SSH (Secure Shell) kautta.

## Todistusaineisto hallintajärjestelmästä:
